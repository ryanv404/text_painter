...
mod regular_fg {
    ...
    test_color!(pr_on_bk: primary, on_black, "hi" => "\x1b[39;40mhi\x1b[0m");
}
...
mod bright_fg {
    ...
    test_color!(br_rd_on_pr: bright_red, on_primary,   "hi" => "\x1b[91;49mhi\x1b[0m");
}
...
mod regular_bg {
    ...
    test_color!(bk_on_pr: black, on_primary, "hi" => "\x1b[30;49mhi\x1b[0m");
}

mod bright_bg {
    test_color!(pr_on_br_bk: primary, on_bright_black, "hi" => "\x1b[39;100mhi\x1b[0m");
...
mod text_attrs {
    ...
    test_color!(ul:       underline, cyan, on_black,  "hi" => "\x1b[4;36;40mhi\x1b[0m");
    test_color!(blnk:     blink, cyan, on_black,      "hi" => "\x1b[5;36;40mhi\x1b[0m");
    ...
    test_color!(bo_pr_bk: bold, primary, on_black,    "hi" => "\x1b[1;39;40mhi\x1b[0m");
    test_color!(bo_cy_pr: bold, cyan, on_primary,     "hi" => "\x1b[1;36;49mhi\x1b[0m");
    test_color!(bo_pr_pr: bold, primary, on_primary,  "hi" => "\x1b[1;39;49mhi\x1b[0m");
}

mod write_style {
    use std::io::Write;
    test_write_style!(mg_on_bk: magenta, on_black,        "hi" => b"\x1b[35;40mhi\x1b[0m");
    test_write_style!(br_rd_on_bk: bright_red, on_black,  "hi" => b"\x1b[91;40mhi\x1b[0m");
    test_write_style!(bk_on_br_bl: black, on_bright_blue, "hi" => b"\x1b[30;104mhi\x1b[0m");
    test_write_style!(bold: bold, cyan, on_black,         "hi" => b"\x1b[1;36;40mhi\x1b[0m");
    test_write_style!(no_fg: bold, primary, on_black,     "hi" => b"\x1b[1;39;40mhi\x1b[0m");
    test_write_style!(color256: color256(156), on_color256(223),
        "hi" => b"\x1b[38;5;156;48;5;223mhi\x1b[0m"
    );
    test_write_style!(rgb: rgb(0, 5, 255), on_rgb(43, 34, 214),
        "hi" => b"\x1b[38;2;0;5;255;48;2;43;34;214mhi\x1b[0m"
    );
}

mod writeln_style {
    use std::io::Write;
    test_writeln_style!(mg_on_bk: magenta, on_black,        "hi" => b"\x1b[35;40mhi\x1b[0m\n");
    test_writeln_style!(br_rd_on_bk: bright_red, on_black,  "hi" => b"\x1b[91;40mhi\x1b[0m\n");
    test_writeln_style!(bk_on_br_bl: black, on_bright_blue, "hi" => b"\x1b[30;104mhi\x1b[0m\n");
    test_writeln_style!(bold: bold, cyan, on_black,         "hi" => b"\x1b[1;36;40mhi\x1b[0m\n");
    test_writeln_style!(no_fg: bold, primary, on_black,     "hi" => b"\x1b[1;39;40mhi\x1b[0m\n");
...
mod macros {
    use crate::{ ansi_csi, ansi_sgr };

    #[test]
    fn ansi_csi_0_args() {
        assert_eq!(ansi_csi!(), "\x1b[");
    }
    #[test]
    fn ansi_csi_1_arg() {
        assert_eq!(ansi_csi!("test1"), "\x1b[test1");
    }
    #[test]
    fn ansi_csi_3_args() {
        assert_eq!(ansi_csi!("test1", "test2", 34), "\x1b[test1test234");
    }
    #[test]
    fn ansi_sgr_1_arg() {
        assert_eq!(ansi_sgr!("test1"), "\x1b[test1m");
    }
    #[test]
    fn ansi_sgr_3_args() {
        assert_eq!(ansi_sgr!("test1", "test2", 34), "\x1b[test1test234m");
    }
}
